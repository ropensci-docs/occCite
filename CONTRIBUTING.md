# Contributing to occCite

First of all, thanks for considering contributing to `occCite`! 👍 It’s
people like you that make it rewarding for us - the project
maintainers - to work on `occCite`. 😊

`occCite` is an open source project, maintained by people who care. We
are not directly funded to do so.

## Code of conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://docs.ropensci.org/occCite/CODE_OF_CONDUCT.md). By
...
Think `occCite` is useful? Let others discover it, by telling them in
person, via Twitter (#occCite) or a blog post.

Using `occCite` for a paper you are writing? Consider [citing
it](https://hannahlowens.github.io/occCite/authors.html).

### Ask a question ⁉️

Using `occCite` and got stuck? Browse the
[documentation](https://hannahlowens.github.io/occCite) to see if you
can find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/hannahlowens/occCite/issues/new). While we
...
Have an idea for a new `occCite` feature? Take a look at the
[documentation](https://hannahlowens.github.io/occCite) and [issue
list](https://github.com/hannahlowens/occCite/issues) to see if it isn’t
...
Using `occCite` and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/hannahlowens/occCite/issues/new) so we can
...
[This website](https://hannahlowens.github.io/occCite) is generated with
...
issue](https://github.com/hannahlowens/occCite/issues/new) and we can
...
Care to fix bugs or implement new functionality for `occCite`? Awesome!
👏 Have a look at the [issue
list](https://github.com/hannahlowens/occCite/issues) and leave a
...
1.  Fork [this repo](https://github.com/hannahlowens/occCite) and clone
